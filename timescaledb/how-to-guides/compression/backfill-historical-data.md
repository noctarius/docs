...
into compressed column form, we do not currently allow certain types of further
modifications of the data (e.g. updates, deletes) or the schema without manual
